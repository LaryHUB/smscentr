...
$select.="\t<option value='USSD_MSG' $c_selected[USSD_MSG]>Command</option>\n";
$select.="\t<option value='USSD_RETURN' $c_selected[USSD_RETURN]>Return</option>\n";
$select.="\t<option value='ERROR_MSG' $c_selected[ERROR_MSG]>Error</option>\n";
$select.="\t<option value='type' $c_selected[type]>Type</option>\n";
$select.="\t<option value='card' $c_selected[card]>Card</option>\n";
$select.="\t<option value='recharge_ok' $c_selected[recharge_ok]>Recharge_ok</option>\n";
$select.="</select>\n";
...
$select.="<input type=\"submit\" value=\"Search\">\n";
        ...
        $fenye=showpage("ussdinfo.php?action=$action&column=$column&type=$type&s_key=$s_key&",$page,$count,$perpage,true,true,"rows");
...
<table wIdth="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="topbg"> 
    <td height="22" colspan="2" align="center"><strong>USSD RECORD</strong></td>
  </tr>
  <tr class="tdbg"> 
    <td wIdth="120" height="30"><strong>USSD Record</strong></td>
    <td height="30"><a href="ussd_ch.php" target=main>Send USSD</a></td>
  </tr>
</table>
<!--
<?php 
...
<table wIdth="100%"  border="0" cellspacing="2" cellpadding="2" nowrap=false>
		...
		<td wIdth="35" align=center height="25"><b>choose</b></td>
                ...
                <td align="center"><b>USSD Return</b></td>
                <td align="center"><b>Terminal</b></td>
                <td align="center"><b>Error Msg</b></td>
		<td align="center"><b>Type</b></td>
		<td align="center"><b>Recharge Card</b></td>
...
-->
		...
		<td width="100" align=center ><a href="?action=del&id={$rs['id']}">Delete  </a></td> 
    </tr>
...
<input type="hIdden" name="boxs" value="{$j}">
                                        <tr>
                                          ...
                                          Choice current page<input name="submit" type='submit' value='Delete selected'><input name="button" type='button' value='Delete All' onClick="if(confirm('Sure to delete all USSD in the database?')) window.location='?action=delall'"></td>
                                        </tr>
                                        <tr>
