...
*/
	...
	$lan=$_POST['lan'];
	$query=$db->query("UPDATE system SET sysname='$sysname',lan=$lan,send_page_jump_enable='$_POST[send_page_jump_enable]', session_time='$_POST[session_time]',json_send_url='$_POST[json_send_url]',json_recv_url='$_POST[json_recv_url]' where 1");
...
<form method="post" action="sys.php?action=save" name="myform" onSubmit="javascript:return check();">
  ...
  <table wIdth="600" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
    ...
    <tr> 
      <td wIdth="150" align="right" class="tdbg"><strong>json汇报短信发送结果的地址:</strong></td>
      <td class="tdbg"><input type="input" name="json_send_url" value="<?php echo $rs[json_send_url] ?>"></td>
    </tr>
    <tr> 
      <td wIdth="150" align="right" class="tdbg"><strong>json汇报短信接收信息的地址:</strong></td>
